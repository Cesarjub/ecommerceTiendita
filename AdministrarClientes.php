...
<html>
			...
			<div class = "row">
              ...
              <svg xmlns = "http://www.w3.org/2000/svg" width = "16" height = "16" fill = "currentColor" class = "bi bi-arrow-right ms-1 me-1" viewBox = "0 0 16 16">
                <path fill-rule = "evenodd" d = "M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
							...
							<li class = "active"><a href = "./AdministrarClientes.php" class = "text-decoration-none">Clientes</a></li>
						</ul>
					</div>
				</div>
			</div>
  ...
  <?php
        ...
        //Consulta
        $sqlClientes = "
        SELECT u.*, r.TIPO_USUARIO FROM usuarios u INNER JOIN rol r ON u.ID_ROL = r.ID_ROL WHERE r.TIPO_USUARIO <=> 'CLIENTE';        
        ";

        //Verificacion de la consulta
        $queryClientes =  $dbh -> prepare($sqlClientes); 
    ...
    <section class = "lista-user container mt-3 table-responsive">
        <table class = "table table-borderless table-responsive card-1 p-4 order-table shadow">
            ...
            foreach($queryClientes as $datosClientes)
            {
              ?>
                    ...
                    <tr class = "border-bottom shadow-sm">
                        ...
                        <td class = "text-start">
                            <div class = "p-2 d-flex flex-row align-items-center mb-2"> 
                                <div class = "d-flex flex-column ml-2"> <span class = "d-block font-weight-bold text-capitalize"  id = "nombre-cliente<?php echo $contador; ?>"><?php echo strtolower($datosClientes['NOMBRE'])." ".strtolower($datosClientes['APELLIDO']); ?></span> 
                                    <small class = "text-muted text-capitalize"><?php echo strtolower($datosClientes['TIPO_USUARIO']); ?></small> </div>
                            </div>
                        </td>
                        <td class = "text-center">
                            <div class = "p-2"> <span class = "d-block font-weight-bold"><?php echo $datosClientes['ULTIMO']; ?></span> </div>
                        </td>
                        <td colspan = "2" class = "text-center">
                            ...
                            <!-- Eliminar - Clientes -->
                            <button class = "btn btn-danger remover-cliente" value = "<?php echo $contador; ?>" id = "<?php echo  $datosClientes['TELEFONO'] ?>">
    ...
    <!-- JavaScript - Clientes -->
    <script src = "./JS/Clientes/EliminarClientes.js" type = "module"></script>
