...
<html>
			...
			<div class = "row">
              ...
              <svg xmlns = "http://www.w3.org/2000/svg" width = "16" height = "16" fill = "currentColor" class = "bi bi-arrow-right ms-1 me-1" viewBox = "0 0 16 16">
                <path fill-rule = "evenodd" d = "M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
							...
							<li class = "active"><a href = "./AdministrarEmpleados.php" class = "text-decoration-none">Empleados</a></li>
						</ul>
					</div>
				</div>
			</div>
  ...
  <div class = "row">
    ...
    <div class = "col-7 d-flex form-buscar">
      <input class = "form-control shadow-none me-1 light-table-filter" type = "search" placeholder = "Buscar" aria-label = "Search" data-table = "order-table">
    ...
    <a type = "button" class = "btn btn-success" href = "./FormularioEmpleados.php">
  ...
  <?php
        ...
        //Consulta
        $sqlEmpleados = "
        SELECT u.*, r.TIPO_USUARIO FROM usuarios u INNER JOIN rol r ON u.ID_ROL = r.ID_ROL WHERE r.TIPO_USUARIO != 'CLIENTE' AND R.TIPO_USUARIO != 'ADMINISTRADOR';        
        ";

        //Verificacion de la consulta
        $queryEmpleados =  $dbh -> prepare($sqlEmpleados); 
    ...
    <!-- Lista de empleados -->
    <section class = "lista-user container mt-3 table-responsive">
        <table id = "tablaEmpleados" class = "table table-borderless table-responsive card-1 p-4 shadow order-table">
            ...
            <thead class = " bg-dark text-white text-center">
                <tr class = "border-bottom">
                    ...
                    <th> <span>Ultimo ingreso</span> </th>
                    <th> <span class = "ml-2">Opción</span> </th>
                </tr>
            </thead>
        ...
        foreach($queryEmpleados as $datosEmpleados)
        {
          ?>
            ...
            <tbody>
                <tr class = "border-bottom shadow-sm">
                    <td class = "text-center">
                        <div class = "p-2"> <span class="d-block font-weight-bold"><?php echo $contador; ?></small> </div>
                    </td>
                    <td class = "text-start">
                        <div class = "p-2 d-flex flex-row align-items-center mb-2"> 
                            <div class = "d-flex flex-column ml-2"> <span class = "d-block font-weight-bold text-capitalize" id = "nombre-empleado<?php echo $contador; ?>"><?php echo strtolower($datosEmpleados['NOMBRE'])." ".strtolower($datosEmpleados['APELLIDO']); ?></span> 
                                <small class = "text-muted text-capitalize"><?php echo strtolower($datosEmpleados['TIPO_USUARIO']); ?></small> </div>
                        </div>
                    </td>
                    <td class = "text-center">
                        <div class = "p-2"> <span class = "d-block font-weight-bold"><?php echo $datosEmpleados['ULTIMO']; ?></span> </div>
                    </td>
                    <td colspan = "2" class = "text-center">
                        <div class = "p-2 "> 
                        
                        <!-- Editar - Empleado -->
                        <a class = "btn btn-primary me-2" href = "./FormularioEmpleados.php?ref=<?php echo  $datosEmpleados['TELEFONO'] ?>">
                        ...
                        <!-- Eliminar - Empleado -->
                        <button class = "btn btn-danger remover-empleado" value = "<?php echo $contador; ?>" id = "<?php echo  $datosEmpleados['TELEFONO'] ?>">
    ...
    <!-- JavaScript - Empleados -->
    <script src = "./JS/Empleados/EliminarEmpleado.js" type = "module"></script>
