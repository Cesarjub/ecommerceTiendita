...
<html>
    <head>
        ...
        <!-- Titulo de la pagina -->
        <title>Tiendita | Empleados</title>
...
<body>
		...
		<div class = "container">
			<div class = "row">
              ...
              <svg xmlns = "http://www.w3.org/2000/svg" width = "16" height = "16" fill = "currentColor" class = "bi bi-arrow-right ms-1 me-1" viewBox = "0 0 16 16">
                ...
                <li><a href = "./AdministrarEmpleados.php" class = "text-decoration-none">Empleados
              <svg xmlns = "http://www.w3.org/2000/svg" width = "16" height = "16" fill = "currentColor" class = "bi bi-arrow-right ms-1 me-1" viewBox = "0 0 16 16">
                <path fill-rule = "evenodd" d = "M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
              </svg>                
                </i></a></li>

							<li class = "active"><a href = "./FormularioEmpleados.php" class = "text-decoration-none">Formulario de empleados</a></li>
						</ul>
					</div>
				</div>
			</div>
    ...
    <?php
        ...
        //Consulta
        $sqlTipoEmpleado = "  
        SELECT * FROM rol WHERE TIPO_USUARIO != 'CLIENTE'
        ";

        //Verificacion de la consulta
        $queryTipoEmpleado =  $dbh -> prepare($sqlTipoEmpleado); 

        //Ejecucion de la consulta
        $queryTipoEmpleado -> execute();


        /***************/

//Consulta
$sqlDatosEmpleado = "SELECT u.*, r.TIPO_USUARIO FROM usuarios u INNER JOIN rol r ON u.ID_ROL = r.ID_ROL WHERE u.TELEFONO = ?;";

//Verificacion de la consulta
$queryDatosEmpleado =  $dbh -> prepare($sqlDatosEmpleado); 

//Ejecucion de la consulta
$queryDatosEmpleado -> execute([$idEmpleado]);

//Datos de la consulta
$empleadosData = $queryDatosEmpleado->fetch(PDO::FETCH_ORI_LAST);        

$TelefonoEmpleado = $empleadosData[0];
$NombreEmpleado = $empleadosData[1];
$ApellidoEmpleado = $empleadosData[2];
$ClaveEmpleado = $empleadosData[3];
$RolEmpleado = $empleadosData[6];
    ...
    ?>
                            ...
                            <div class = "col-12 col-md-6">
                                ...
                                <select class = "form-select text-capitalize" id = "combo-tipo-empleado" name = "combo-tipo-empleado"  aria-label = "Default select example">
                                
                                <option value = "0">Selecciona una opción</option>

    <?php

          foreach($queryTipoEmpleado as $datosTipoEmpleado)
          {
            ?>                                
                                <option value = "<?php echo $datosTipoEmpleado['ID_ROL'] ?>" 
                                <?php 
                                if($datosTipoEmpleado['TIPO_USUARIO'] == $RolEmpleado) 
                                echo 'selected = "selected"'; 
                                ?> 
                                class = "text-capitalize"><?php echo strtolower($datosTipoEmpleado['TIPO_USUARIO']) ?></option>
            <?php
    ...
    ?>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <div class = "col-12 col-md-6">
                                    <label for = "telefono-empleado" class = "form-label">Número de teléfono:</label>
                                      <input type = "tel" class = "form-control" name = "telefono-empleado" 
                                        id = "telefono-empleado" pattern = "[0-9]{10}" size = "10" 
                                        title = "El número de teléfono debe de consistir en 10 dígitos." value = "<?php echo $TelefonoEmpleado; ?>" required>
                                </div>

                            </div>  

                            <input type = "tel" class = "form-control d-none" name = "id-empleado" 
                                        id = "id-empleado" value = "<?php echo $TelefonoEmpleado; ?>">

                            <div class = "row justify-content-center mb-2">

                                <!-- Nombre del empleado -->
                                <div class = "col-12 col-md-6">
                                    <label for = "nombre-empleado" class = "form-label">Nombre del empleado:</label>
                                    <input type = "text" class = "form-control text-capitalize" name = "nombre-empleado" id = "nombre-empleado"  value = "<?php echo strtolower($NombreEmpleado); ?>" required>
                                </div>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <div class = "col-12 col-md-6">
                                    <label for = "apellido-empleado" class = "form-label">Apellidos del empleado:</label>
                                    <input type = "text" class = "form-control text-capitalize" name = "apellido-empleado" id = "apellido-empleado"  value = "<?php echo strtolower($ApellidoEmpleado); ?>" required>
                                </div>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <!-- Clave del empleado -->
                                <div class = "col-12 col-md-6">
                                    <label for = "clave-empleado" class = "form-label">Contraseña: <span class = "fst-italic">(Mínimo 6 caracteres)</span></label>
                                    <input type = "password" class = "form-control" id = "clave-empleado" name = "clave-empleado" 
                                                pattern = ".{6,}" title = "La contraseña debe de ser de 6 caracteres mínimo."  value = "<?php echo $ClaveEmpleado; ?>" required>
                                </div>
                          ...
                          {
                          ?>
                              <button type = "submit" class = "btn btn-success mt-3 mb-5" id = "btn-form-empleado">Modificar empleado</button>
                          <?php 
                          }
                          else
                          {
                          ?>
                              <button type = "submit" class = "btn btn-success mt-3 mb-5" id = "btn-form-empleado">Guardar empleado</button>
                          <?php 
                          }
                          ?>    
                                </span>        
    ...
    <!-- JavaScript - Empleado -->
    <script src = "./JS/Empleados/AgregarEmpleado.js" type = "module"></script>
