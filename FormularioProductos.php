...
<body>
		...
		<div class = "container">
			<div class = "row">
              ...
              <svg xmlns = "http://www.w3.org/2000/svg" width = "16" height = "16" fill = "currentColor" class = "bi bi-arrow-right ms-1 me-1" viewBox = "0 0 16 16">
                ...
                <li><a href = "./AdministrarProductos.php" class = "text-decoration-none">Productos
              <svg xmlns = "http://www.w3.org/2000/svg" width = "16" height = "16" fill = "currentColor" class = "bi bi-arrow-right ms-1 me-1" viewBox = "0 0 16 16">
                <path fill-rule = "evenodd" d = "M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
              </svg>                
                </i></a></li>

							<li class = "active"><a href = "./FormularioProductos.php" class = "text-decoration-none">Formulario de productos</a></li>
						</ul>
					</div>
				</div>
			</div>
    ...
    <?php
        ...
        $queryTipoProducto =  $dbh -> prepare($sqlTipoProducto); 

        //Ejecucion de la consulta
        $queryTipoProducto -> execute();
        ...
        //Verificacion de la consulta
        $queryMarcaProducto =  $dbh -> prepare($sqlMarcaProducto); 

        //Ejecucion de la consulta
        $queryMarcaProducto -> execute();

        /***************/

//Consulta
$sqlDatosProductos = "SELECT p.*, c.TIPO_PR, m.NOMBRE_MARCAS FROM productos p INNER JOIN categoria c ON p.ID_CT = c.ID_CT
INNER JOIN marcas m ON p.ID_MARCAS = m.ID_MARCAS WHERE p.ID_P = ?;";

//Verificacion de la consulta
$queryDatosProductos =  $dbh -> prepare($sqlDatosProductos); 

//Ejecucion de la consulta
$queryDatosProductos -> execute([$idProducto]);

//Datos de la consulta
$productosData = $queryDatosProductos->fetch(PDO::FETCH_ORI_LAST);        

$NombreProducto = $productosData[1];
$PrecioProducto = $productosData[2];
$StockProducto = $productosData[3];
$ImagenProducto = $productosData[3];
$CategoriaProducto = $productosData[8];
$MarcaProducto = $productosData[9];
    ...
    ?>
        ...
        <section class = "mt-3">
            <div class = "container w-75 mb-lg-6 rounded shadow border-5">
                <div class = "row pb-4">
                    ...
                    <div class = "container-fluid"> <!--  action = "./PHP/Productos/AgregarProducto.php" -->
                        <form id = "form-productos" method = "POST" enctype = "multipart/form-data">
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <div class = "col-12 col-md-6">
                                    ...
                                    <select class = "form-select text-capitalize" aria-label = "Default select example" id = "select-tipo" name = "select-tipo">
                                
                                <option value = "0">Selecciona una opción</option>

<?php

foreach($queryTipoProducto as $datosTipoProducto)
{
  ?>                                
                      <option value = "<?php echo $datosTipoProducto['ID_CT'] ?>" 
                      <?php 
                      if($datosTipoProducto['TIPO_PR'] == $CategoriaProducto) 
                      echo 'selected = "selected"'; 
                      ?> 
                      class = "text-capitalize"><?php echo strtolower($datosTipoProducto['TIPO_PR']) ?></option>
  <?php
...
?>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <div class = "col-12 col-md-6">
                                    ...
                                    <input type = "text" class = "form-control" name = "nombre-producto" id = "nombre-producto"  value = "<?php echo $NombreProducto; ?>"  required>
                                </div>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <!-- Marca del producto -->
                                <div class = "col-12 col-md-6">
                                    <label for = "marca-producto" class = "form-label">Marca del producto:</label>
                                    <select class = "form-select text-capitalize" aria-label = "Default select example" id = "select-marca" name = "select-marca">
                                
                                <option value = "0">Selecciona una opción</option>

    <?php

          foreach($queryMarcaProducto as $datosMarcaProducto)
          {
            ?>                                
                                <option value = "<?php echo $datosMarcaProducto['ID_MARCAS'] ?>" 
                                <?php 
                                if($datosMarcaProducto['NOMBRE_MARCAS'] == $MarcaProducto) 
                                echo 'selected = "selected"'; 
                                ?> 
                                class = "text-capitalize"><?php echo strtolower($datosMarcaProducto['NOMBRE_MARCAS']) ?></option>
            <?php
    ...
    ?>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <div class = "col-12 col-md-6">
                                    ...
                                    <input class = "form-control form-control" type = "file" name = "imagen-producto" id = "imagen-producto"  accept = "image/*" >
                                </div>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <div class = "col-12 col-md-6">
                                    <label for = "stock-producto" class = "form-label">Stock del producto:</label>
                                    <input type = "number" class = "form-control" name = "stock-producto" id = "stock-producto"  value = "<?php echo $StockProducto; ?>"  required>
                                </div>
                            ...
                            <div class = "row justify-content-center mb-2">
                                ...
                                <!-- Precio del producto -->
                                <div class = "col-12 col-md-6">
                                    <label for = "precio-producto" class = "form-label">Precio del producto:</label>
                                    <input type = "number" placeholder = "$" class = "form-control" name = "precio-producto" id = "precio-producto"  value = "<?php echo $PrecioProducto; ?>"  required>
                                </div>

                            </div> 

                            <input type = "number" class = "form-control d-none" name = "id-producto" id = "id-producto"  value = "<?php echo $idProducto; ?>">
                            
                            <!-- Guardar producto -->
                            <div class = "row justify-content-center d-grid mt-4 mb-2">
                                <div class = "col">

                                    <span class = "float-left">
                                        <button type = "reset" class = "btn btn-danger mt-3 mb-5 me-2">Limpiar</button>
                                    </span>
                          ...
                          {
                          ?>
                              <button type = "submit" class = "btn btn-success mt-3 mb-5" id = "btn-form-producto" name = "btn-form-producto">Modificar producto</button>
                          <?php 
                          }
                          else
                          {
                          ?>
                              <button type = "submit" class = "btn btn-success mt-3 mb-5" id = "btn-form-producto" name = "btn-form-producto">Guardar producto</button>
                          <?php 
                          }
                          ?>    
                                    </span>
    ...
    <!-- JavaScript - Validar productos -->
    <script src = "./JS/Productos/ValidarIngresoProducto.js" type = "module"></script>
