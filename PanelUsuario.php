...
<html>
    <head>
        ...
        <!-- Titulo de la pagina -->
        <title>Tiendita | Bienvenido</title>
    ...
    <section class = "opciones-menu">
        <div class = "container" data-aos = "fade-up">
  
          <div class = "section-title-panel text-start">
            <h2 class = "text-capitalize"><?php echo strtolower($_SESSION['rolUsuario']) ?></h2>
          </div>
        ...
        ?>
            ...
            <div class = "col-md-6 col-lg-3 align-items-stretch mb-5 mb-lg-0" data-aos = "fade-up" data-aos-delay = "100">
              <div class = "icon-box shadow rounded-3">
                <div class = "icon mt-3">
                    <i class = "bi bi-columns-gap"></i>                   
                </div>
                <h4 class = "title"><a href = "./AdministrarProductos.php" class = "text-decoration-none">Productos</a></h4>
            ...
            <div class = "col-md-6 col-lg-3 align-items-stretch mb-5 mb-lg-0" data-aos = "fade-up" data-aos-delay = "100">
              <div class = "icon-box shadow rounded-3">
                ...
                <h4 class = "title"><a href = "#" class = "text-decoration-none">Promociones</a></h4>
                <p class = "description"></p>
              </div>
            </div>-->
            ...
            <div class = "col-md-6 col-lg-3 align-items-stretch mb-5 mb-lg-0" data-aos = "fade-up" data-aos-delay = "100">
              <div class = "icon-box shadow rounded-3">
                ...
                <h4 class = "title"><a href = "./AdministrarPedidos.php" class = "text-decoration-none">Pedidos</a></h4>
                <p class = "description"></p>
              </div>
            </div>
            ...
            <div class = "col-md-6 col-lg-3 align-items-stretch mb-5 mb-lg-0" data-aos = "fade-up" data-aos-delay = "100">
              <div class = "icon-box shadow rounded-3">
                ...
                <h4 class = "title"><a href = "./AdministrarClientes.php" class = "text-decoration-none">Clientes</a></h4>
                <p class = "description"></p>
              </div>
            </div>
            ...
            <div class = "col-md-6 col-lg-3 align-items-stretch mb-5 mb-lg-0" data-aos = "fade-up" data-aos-delay = "100">
              <div class = "icon-box shadow rounded-3">
                ...
                <h4 class = "title"><a href = "./AdministrarEmpleados.php" class = "text-decoration-none">Empleados</a></h4>
                <p class = "description"></p>
              </div>
            </div>  
    ...
    <div style = "margin-top:150px;">Hey</div>
