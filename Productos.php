...
<body>
        ...
        <!-- Baner de pagina -->
        <section id = "seccion-prod" class = "banner-sc">
...
$dbh = $nuevaConexion -> conectar();
    ...
    <?php         
        ...
        SELECT p.*, m.NOMBRE_MARCAS FROM productos p INNER JOIN marcas m ON m.ID_MARCAS = p.ID_MARCAS WHERE p.ID_CT = 1 ORDER BY p.ID_P
        ;");
